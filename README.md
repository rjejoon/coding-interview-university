...
- ### Linked Lists
    ...
    - [ ] implement (I did with tail pointer & without): (implemented only without tail pointer)
...
- ### Hash table
    ...
    - [x] implement with array using linear probing (C: freeing multiple identical allocated hashtables does not work)
...
- ### Heap / Priority Queue / Binary Heap
    ...
    - [ ] [MIT: Heaps and Heap Sort (video)](https://www.youtube.com/watch?v=B7hVxCmfPtM&index=4&list=PLUl4u3cNGP61Oq3tWYp6V_F-5jb5L2iHb) (watch it from 15:48)
